...
abstract class Twig_Tests_Profiler_Dumper_AbstractTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return $this->generateProfile('main', 1, true, 'template', 'users_index.twig', $subProfiles);
    }
    ...
    {
        return $this->generateProfile('foo', 0.0001, false, 'macro', 'users_index.twig', $subProfiles);
    }
