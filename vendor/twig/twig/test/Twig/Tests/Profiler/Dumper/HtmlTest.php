...
└ <span style="background-color: #ffd">users_index.twig</span> <span style="color: #d44">%d.%dms/%d%</span>
  ...
  └ users_index.twig::macro(<span style="background-color: #ddf">foo</span>)
  └ <span style="background-color: #ffd">embedded.twig</span>
    └ <span style="background-color: #ffd">included.twig</span>
</pre>
EOF
